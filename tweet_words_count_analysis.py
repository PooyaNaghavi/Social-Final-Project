...
for person in ['Donald_Trump', 'Barack_Obama']:
    sentences = utils.get_sentences(f'{person}_tweets.json')
    ...
    invalid_keys = ['the', 'to', 'a', 'of', 's', 'obama', 'in', 'for', 'and', 'you', 'is', 'on',
                    'we', 'president', 'president', 'that', 'it', 'this', 'our', 'their', 'out',
                    'your', 'i', 'http', 'have', 'are', 'more', 'at', 'with', 'if', 'be', 'can',
                    'will', 'not', "n't", 'from', 'who', 'as', 'do', 're', 'all', 'should', 'has', 'has', 'get', 'what',
    ...
    plt.ylabel('counts')
    plt.title('words')
    plt.savefig(f'img/{person}_tweet_lengths_words_count.png')
